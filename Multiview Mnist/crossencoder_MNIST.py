...
if dataset == 1:
    ...
    num_clusters = 10
    i_shape = [28 * 28, 28 * 28]
    X1, X2, XV1, XV2, XTe1, XTe2, label, labelTe = create_dataset(rng)
...
t_Lyu0 = time.perf_counter()
Lyu_best_models_0, Lyu_best_losses_0, Lyu_all_models_0 = train_Lyu_et_all(i_shape, args, num_init, data_tr, data_val, data_te)
t_Lyu_0 = time.perf_counter() - t_Lyu0
torch.save({'model_state_dict': Lyu_best_models_0, 'loss': Lyu_best_losses_0, 'models_state_dict': Lyu_all_models_0, 'time':t_Lyu_0}, path + '/LyuModels_0')
...
t_Lyu_1 = time.perf_counter() - t_Lyu0
torch.save({'model_state_dict': Lyu_best_models_1, 'loss': Lyu_best_losses_1, 'models_state_dict': Lyu_all_models_1, 'time':t_Lyu_1}, path + '/LyuModels_1')
...
if True:
    ...
    print('Lyu_0 mean:', np.mean(NMI_Lyu_0, 1))
    print('Lyu_0 std:', np.std(NMI_Lyu_0, 1))
    print('Lyu_1 mean:', np.mean(NMI_Lyu_1, 1))
    print('Lyu_1 std:', np.std(NMI_Lyu_1, 1))
    ...
    print('Lyu_0 mean:', np.mean(ARI_Lyu_0, 1))
    print('Lyu_0 std:', np.std(ARI_Lyu_0, 1))
    print('Lyu_1 mean:', np.mean(ARI_Lyu_1, 1))
    print('Lyu_1 std:', np.std(ARI_Lyu_1, 1))
    ...
    print('Lyu_0 mean:', np.mean(ACC_Lyu_0, 1))
    print('Lyu_0 std:', np.std(ACC_Lyu_0, 1))
    print('Lyu_1 mean:', np.mean(ACC_Lyu_1, 1))
    print('Lyu_1 std:', np.std(ACC_Lyu_1, 1))
    ...
    print('Lyu_0 mean:', np.mean(CACC_Lyu_0, 1))
    print('Lyu_0 std:', np.std(CACC_Lyu_0, 1))
    print('Lyu_1 mean:', np.mean(CACC_Lyu_1, 1))
    print('Lyu_1 std:', np.std(CACC_Lyu_1, 1))
    print('DGCCA mean:', np.mean(CACC_DGCCA))
    print('DGCCA std:', np.std(CACC_DGCCA))
    print('CCA', CACC_LCCA)

    print('Times')
    print('DGCCA:', t_DGCCA / (2 * num_init))
    print('DCCAE:', t_DCCAE / (num_init * 5))
    print('proposed:', t_XE / (num_init * 5))
    print('Lyu_0:', t_Lyu_0 / (num_init * 5))
    print('Lyu_1:', t_Lyu_1 / (num_init * 5))
    print('CCA:', t_CCA)
...
if True:
    ...
    plt.fill_between(p_l, np.mean(ARI_XE, 1) - np.std(ARI_XE, 1), np.mean(ARI_XE, 1) + np.std(ARI_XE, 1), alpha=0.2,
                     edgecolor='blue', facecolor='blue')
    plt.fill_between(p_l, np.mean(ARI_DCCAE, 1) - np.std(ARI_DCCAE, 1), np.mean(ARI_DCCAE, 1) + np.std(ARI_DCCAE, 1),
                     alpha=0.2, edgecolor='orange', facecolor='orange')
    plt.fill_between(p_l, np.mean(ARI_Lyu_0, 1) - np.std(ARI_Lyu_0, 1), np.mean(ARI_Lyu_0, 1) + np.std(ARI_Lyu_0, 1),
                     alpha=0.2, edgecolor='cyan', facecolor='cyan')
    plt.fill_between(p_l, np.mean(ARI_Lyu_1, 1) - np.std(ARI_Lyu_1, 1), np.mean(ARI_Lyu_1, 1) + np.std(ARI_Lyu_1, 1),
                     alpha=0.2, edgecolor='black', facecolor='black')
    plt.fill_between(p_l, (np.mean(ARI_DGCCA) - np.std(ARI_DGCCA)) * np.ones(len(p_l)),
                     (np.mean(ARI_DGCCA) + np.std(ARI_DGCCA)) * np.ones(len(p_l)), alpha=0.2, edgecolor='green',
                     facecolor='green')
    ...
    plt.fill_between(p_l, np.mean(NMI_XE, 1) - np.std(NMI_XE, 1), np.mean(NMI_XE, 1) + np.std(NMI_XE, 1), alpha=0.2,
                     edgecolor='blue', facecolor='blue')
    plt.fill_between(p_l, np.mean(NMI_DCCAE, 1) - np.std(NMI_DCCAE, 1), np.mean(NMI_DCCAE, 1) + np.std(NMI_DCCAE, 1),
                     alpha=0.2, edgecolor='orange', facecolor='orange')
    plt.fill_between(p_l, np.mean(NMI_Lyu_0, 1) - np.std(NMI_Lyu_0, 1), np.mean(NMI_Lyu_0, 1) + np.std(NMI_Lyu_0, 1),
                     alpha=0.2, edgecolor='cyan', facecolor='cyan')
    plt.fill_between(p_l, np.mean(NMI_Lyu_1, 1) - np.std(NMI_Lyu_1, 1), np.mean(NMI_Lyu_1, 1) + np.std(NMI_Lyu_1, 1),
                     alpha=0.2, edgecolor='black', facecolor='black')
    plt.fill_between(p_l, (np.mean(NMI_DGCCA) - np.std(NMI_DGCCA)) * np.ones(len(p_l)),
                     (np.mean(NMI_DGCCA) + np.std(NMI_DGCCA)) * np.ones(len(p_l)), alpha=0.2, edgecolor='green',
                     facecolor='green')
    plt.legend(['proposed', 'DCCAE', 'Lyu et al. (beta = 0)', 'Lyu et al. (beta = 0.001)', 'DGCCA', 'LCCA'])
    plt.xlabel("lambda")
    plt.ylabel("NMI")
    ...
    plt.fill_between(p_l, np.mean(ACC_XE, 1) - np.std(ACC_XE, 1), np.mean(ACC_XE, 1) + np.std(ACC_XE, 1), alpha=0.2,
                     edgecolor='blue', facecolor='blue')
    plt.fill_between(p_l, np.mean(ACC_DCCAE, 1) - np.std(ACC_DCCAE, 1), np.mean(ACC_DCCAE, 1) + np.std(ACC_DCCAE, 1),
                     alpha=0.2, edgecolor='orange', facecolor='orange')
    plt.fill_between(p_l, np.mean(ACC_Lyu_0, 1) - np.std(ACC_Lyu_0, 1), np.mean(ACC_Lyu_0, 1) + np.std(ACC_Lyu_0, 1),
                     alpha=0.2, edgecolor='cyan', facecolor='cyan')
    plt.fill_between(p_l, np.mean(ACC_Lyu_1, 1) - np.std(ACC_Lyu_1, 1), np.mean(ACC_Lyu_1, 1) + np.std(ACC_Lyu_1, 1),
                     alpha=0.2, edgecolor='black', facecolor='black')
    plt.fill_between(p_l, (np.mean(ACC_DGCCA) - np.std(ACC_DGCCA)) * np.ones(len(p_l)),
                     (np.mean(ACC_DGCCA) + np.std(ACC_DGCCA)) * np.ones(len(p_l)), alpha=0.2, edgecolor='green',
                     facecolor='green')
    plt.legend(['proposed', 'DCCAE', 'Lyu et al. (beta = 0)', 'Lyu et al. (beta = 0.001)', 'DGCCA', 'LCCA'])
    plt.xlabel("lambda")
    plt.ylabel("ACC")
    ...
    plt.fill_between(p_l, np.mean(CACC_XE, 1) - np.std(CACC_XE, 1), np.mean(CACC_XE, 1) + np.std(CACC_XE, 1), alpha=0.2,
                     edgecolor='blue', facecolor='blue')
    plt.fill_between(p_l, np.mean(CACC_DCCAE, 1) - np.std(CACC_DCCAE, 1),
                     np.mean(CACC_DCCAE, 1) + np.std(CACC_DCCAE, 1), alpha=0.2, edgecolor='orange', facecolor='orange')
    plt.fill_between(p_l, np.mean(CACC_Lyu_0, 1) - np.std(CACC_Lyu_0, 1),
                     np.mean(CACC_Lyu_0, 1) + np.std(CACC_Lyu_0, 1), alpha=0.2, edgecolor='cyan', facecolor='cyan')
    plt.fill_between(p_l, np.mean(CACC_Lyu_1, 1) - np.std(CACC_Lyu_1, 1),
                     np.mean(CACC_Lyu_1, 1) + np.std(CACC_Lyu_1, 1), alpha=0.2, edgecolor='black', facecolor='black')
    plt.fill_between(p_l, (np.mean(CACC_DGCCA) - np.std(CACC_DGCCA)) * np.ones(len(p_l)),
                     (np.mean(CACC_DGCCA) + np.std(CACC_DGCCA)) * np.ones(len(p_l)), alpha=0.2, edgecolor='green',
                     facecolor='green')
    plt.legend(['proposed', 'DCCAE', 'Lyu et al. (beta = 0)', 'Lyu et al. (beta = 0.001)', 'DGCCA', 'LCCA'])
    plt.xlabel("lambda")
    plt.ylabel("CACC")
...
if True:
    ...
    plt.fill_between(p_l, mean_corrs_XE_te - std_corrs_XE_te, mean_corrs_XE_te + std_corrs_XE_te, alpha=0.2,
                     edgecolor='blue', facecolor='blue')
    plt.fill_between(p_l, mean_corrs_DCCAE_te - std_corrs_DCCAE_te, mean_corrs_DCCAE_te + std_corrs_DCCAE_te, alpha=0.2,
                     edgecolor='orange', facecolor='orange')
    plt.fill_between(p_l, mean_corrs_Lyu_te_0 - std_corrs_Lyu_te_0, mean_corrs_Lyu_te_0 + std_corrs_Lyu_te_0, alpha=0.2,
                     edgecolor='cyan', facecolor='cyan')
    plt.fill_between(p_l, mean_corrs_Lyu_te_1 - std_corrs_Lyu_te_1, mean_corrs_Lyu_te_1 + std_corrs_Lyu_te_1, alpha=0.2,
                     edgecolor='black', facecolor='black')
    plt.fill_between(p_l, (mean_corr_DGCCA_te - std_corr_DGCCA_te) * np.ones(len(p_l)),
                     (mean_corr_DGCCA_te + std_corr_DGCCA_te) * np.ones(len(p_l)), alpha=0.2, edgecolor='green',
                     facecolor='green')
    plt.legend(['proposed', 'DCCAE', 'Lyu et al. (beta = 0)', 'Lyu et al. (beta = 0.001)', 'DGCCA', 'LCCA'])
    plt.xlabel("lambda")
    ...
    times = [t_XE / (num_init * 5), t_DCCAE / (num_init * 5), t_Lyu_0 / (num_init * 5), t_Lyu_1 / (num_init * 5),
             t_DGCCA / (num_init * 2), t_CCA]
...
if True:
    ...
    X1_emb = TSNE(n_components=2, init='random').fit_transform(Red_Te)
    plt.clf()
    ...
    for i in range(len(p_l)):
        ...
        E1 = best_join_encs_Lyu_0[i][2].to(torch.device('cpu'))
        X1_emb = TSNE(n_components=2, init='random').fit_transform(E1)
        plt.clf()
        plt.scatter(X1_emb[:, 0], X1_emb[:, 1], c=colors_te)
        ...
        plt.grid()
        # plt.show()
        plt.savefig(path + '/Lyu_0' + str(p_l[i]) + '.pdf', format="pdf")

        E1 = best_join_encs_Lyu_1[i][2].to(torch.device('cpu'))
        X1_emb = TSNE(n_components=2, init='random').fit_transform(E1)
        plt.clf()
        plt.scatter(X1_emb[:, 0], X1_emb[:, 1], c=colors_te)
        plt.title('Multiview Mnist ' + str(p_l[i]) + ' Lyu et al.')
        ...
        plt.grid()
        # plt.show()
        plt.savefig(path + '/Lyu_1' + str(p_l[i]) + '.pdf', format="pdf")

# Store results
mdic = {"CACC_XE": CACC_XE, "CACC_DCCAE": CACC_DCCAE, "CACC_DGCCA": CACC_DGCCA, "CACC_Lyu_0": CACC_Lyu_0,
        "CACC_Lyu_1": CACC_Lyu_1, "CACC_LCCA": CACC_LCCA, "ACC_XE": ACC_XE, "ACC_DCCAE": ACC_DCCAE, "ACC_DGCCA": ACC_DGCCA, "ACC_Lyu_0": ACC_Lyu_0,
        "ACC_Lyu_1": ACC_Lyu_1, "ACC_LCCA": ACC_LCCA, "NMI_XE": NMI_XE, "NMI_DCCAE": NMI_DCCAE, "NMI_DGCCA": NMI_DGCCA, "NMI_LCAA": NMI_LCCA, "NMI_Lyu_0": NMI_Lyu_0,
        "NMI_Lyu_1": NMI_Lyu_0, "ARI_XE": ARI_XE,
        "ARI_DCCAE": ARI_DCCAE, "ARI_DGCCA": ARI_DGCCA, "ARI_LCCA": ARI_LCCA, 
        "ARI_Lyu_0": ARI_Lyu_0, "ARI_Lyu_1": ARI_Lyu_1, "all_Ds_XE": all_Ds_XE,
        "all_Ds_DCCAE": all_Ds_DCCAE, "all_Ds_DGCCA": all_Ds_DGCCA, "all_Ds_Lyu_0": all_Ds_Lyu_0,
        "all_Ds_Lyu_1": all_Ds_Lyu_1, "linear_cca_corr": linear_cca_corr[2]}
